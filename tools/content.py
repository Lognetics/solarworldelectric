...
# ---------------------------------------------------------------------------
WA_REVIEWS = [
    {"shot": "wa-seun-oniru.jpg", "who": "Mr Seun O.", "where": "Residential customer",
    ...
    {"shot": "wa-two-years.jpg", "who": "Long-term customer", "where": "Two years after installation",
    ...
    {"shot": "wa-wolerus.jpg", "who": "Mr Wolerus A.", "where": "Residential customer",
    ...
    {"shot": "wa-mr-paul-office.jpg", "who": "Mr Paul", "where": "Office installation",
    ...
    {"shot": "wa-prof-isaac.jpg", "who": "Prof. Isaac", "where": "Residential customer",
    ...
    {"shot": "wa-mr-wole.jpg", "who": "Mr Wole", "where": "Residential customer",
    ...
    {"shot": "wa-freezer.jpg", "who": "Verified customer", "where": "Home installation",
    ...
    {"shot": "wa-can-attest.jpg", "who": "Verified customer", "where": "Home installation",
    ...
    {"shot": "wa-mrs-ijeoma.jpg", "who": "Mrs Ijeoma", "where": "Residential customer",
...
WHY_US = [
    ...
    ("Customised solutions for every need",
     ...
     "a system that fits — not a package pulled off a shelf.",
     "sliders"),
